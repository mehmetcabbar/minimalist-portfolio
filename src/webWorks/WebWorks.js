            ...
            <div style={parent} className='webWorksWrapper'>
                <HorizontalScroll>
                    <div style={child} className='webWorkBox bg'>
                        <a href='https://quitbuddy.app/' target='_blank' className='webLink'>
                            <img src={QuitWeb} className='webWorksImage' alt='quit buddy' />
                            <div className='webTitleBox'>
                                <h5 className='workLittleTitle'>Quit Buddy / Web Site</h5>
                            </div>
                        </a>
                    </div>
                    <div style={child} className='webWorkBox bg'>
                        <a href='http://en.maysogutma.com/' target='_blank' className='webLink'>
                            <img src={Mayso} className='webWorksImage' alt='mayso ice machine and cooling system' />
                            <div className='webTitleBox'>
                                <h5 className='workLittleTitle'>Mayso Ice Machines / Web Site</h5>
                            </div>
                        </a>
                    </div>
                    <div style={child} className='webWorkBox bg'>
                        <a href='http://en.vtllog.com/' target='_blank' className='webLink'>
                            <img src={VtlLog} className='webWorksImage' alt='vtl logistic' />
                            <div className='webTitleBox'>
                                <h5 className='workLittleTitle'>Vtl Logistics / Web Site</h5>
                            </div>
                        </a>
                    </div>
                    <div style={child} className='webWorkBox bg'>
                        <a href='http://candanozturk.com/' target='_blank' className='webLink'>
                            <img src={Candan} className='webWorksImage' alt='painter candan ozturk' />
                            <div className='webTitleBox'>
                                <h5 className='workLittleTitle'>Painter Candan Öztürk / Web Site</h5>
                            </div>
                        </a>
                    </div>
                    <div style={child} className='webWorkBox bg'>
                        <a href='http://karincahazirlik.com/' target='_blank' className='webLink'>
                            <img src={KarincaWeb} className='webWorksImage' alt='karinca' />
                            <div className='webTitleBox'>
                                <h5 className='workLittleTitle'>Karınca Hazırlık / Web Site</h5>
                            </div>
                        </a>
                    </div>
                </HorizontalScroll>
